...
class BindMapTest {
  ...
  @Test
  void getTest() {
    var bindVariable1 = new BindVariable(BindName.valueOf("name1"), Integer.class, null);
    var bindVariable2 = new BindVariable(BindName.valueOf("bind2"), Double.class, null);
    var map = new BindMap(List.of(bindVariable1, bindVariable2));
    assertThat(map.get(BindName.valueOf("name1"))).isEqualTo(bindVariable1);
    assertThat(map.get(BindName.valueOf("bind2"))).isEqualTo(bindVariable2);
    assertThatThrownBy(() -> map.get(BindName.valueOf("bind")))
  ...
  void isSupersetOfTest() {
    var bindVariable1 = new BindVariable(BindName.valueOf("name1"), Integer.class, null);
    var bindVariable2 = new BindVariable(BindName.valueOf("bind2"), Double.class, null);
    var bindVariable2a = new BindVariable(BindName.valueOf("bind2"), Double.class, 5d);
    var bindVariable3 = new BindVariable(BindName.valueOf("bind3"), String.class, "a");
