    ...
    return Stream.of(
        ...
        , new Object[]{new SelectImpl(
            ...
            "{\"SELECT\":{\"COLUMNS\":{\"COLUMN\":[{\"EXPRESSION\":{\"EXPRESSION\":{\"COLUMN\":"
                ...
                + "{\"TABLENAME\":\"brc_series_tb\",\"ALIAS\":\"series\"}}],\"WHERE\":"
                + "{\"EQ\":{\"EXPR1\":{\"COLUMN\":{\"TYPE\":\"UID\",\"TABLE\":\"prog\","
                + "\"COLUMN\":\"series_id\"}},\"EXPR2\":{\"COLUMN\":{\"TYPE\":\"UID\","
                + "\"TABLE\":\"series\",\"COLUMN\":\"series_id\"}}}}}",
            "<?xml version=\"1.0\" encoding=\"UTF-8\"?><SELECT><SELECT><COLUMNS><COLUMN>"
                + "<EXPRESSION><EXPRESSION><COLUMN><TYPE>UID</TYPE><TABLE/><COLUMN>prog_id"
                + "</COLUMN></COLUMN></EXPRESSION><ALIAS/></EXPRESSION></COLUMN></COLUMNS>"
                + "</SELECT><FROM><ELEM><FROMTABLE><TABLENAME>brc.brc_prog_tb"
                + "</TABLENAME><ALIAS>prog</ALIAS></FROMTABLE></ELEM><ELEM><FROMTABLE>"
