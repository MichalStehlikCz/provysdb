...
class ProvysStatementImpl<T extends Statement> implements ProvysStatement {
    @Nonnull
    final T statement;
    ...
    @Override
    public ProvysConnection getConnection() throws SQLException {
        return (ProvysConnection) statement.getConnection();
    }
    ...
    @Override
    public ProvysResultSet getGeneratedKeys() throws SQLException {
