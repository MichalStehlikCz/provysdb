...
public class ProvysPreparedStatement implements PreparedStatement {

    private final PreparedStatement preparedStatement;

    ProvysPreparedStatement(PreparedStatement preparedStatement) {
        this.preparedStatement = preparedStatement;
    }

    @Override
    public ProvysResultSet executeQuery() throws SQLException {
        return new ProvysResultSet(preparedStatement.executeQuery());
    }
