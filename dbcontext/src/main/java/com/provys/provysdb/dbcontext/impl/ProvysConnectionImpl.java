 ...
 */
class ProvysConnectionImpl implements DbConnection {
    ...
    ProvysConnectionImpl(Connection connection, SqlTypeMap sqlTypeMap) {
    ...
    public DbPreparedStatement prepareStatement(String sql) throws SQLException {
        return new ProvysPreparedStatementImpl<>(connection.prepareStatement(sql), sqlTypeMap);
    }

    @Override
    @Nonnull
    public DbCallableStatement prepareCall(String sql) throws SQLException {
        return new ProvysCallableStatementImpl<>(connection.prepareCall(sql), sqlTypeMap);
    }
    ...
    public DbCallableStatement prepareCall(String sql, int resultSetType, int resultSetConcurrency, int resultSetHoldability) throws SQLException {
        return new ProvysCallableStatementImpl<>(connection.prepareCall(sql, resultSetType, resultSetConcurrency, resultSetHoldability), sqlTypeMap);
    }

    @Override
    @Nonnull
    public DbPreparedStatement prepareStatement(String sql, int autoGeneratedKeys) throws SQLException {
        return new ProvysPreparedStatementImpl<>(connection.prepareStatement(sql, autoGeneratedKeys), sqlTypeMap);
    }

    @Override
    @Nonnull
    public DbPreparedStatement prepareStatement(String sql, int[] columnIndexes) throws SQLException {
        return new ProvysPreparedStatementImpl<>(connection.prepareStatement(sql, columnIndexes), sqlTypeMap);
    }

    @Override
    @Nonnull
    public DbPreparedStatement prepareStatement(String sql, String[] columnNames) throws SQLException {
        return new ProvysPreparedStatementImpl<>(connection.prepareStatement(sql, columnNames), sqlTypeMap);
    }
