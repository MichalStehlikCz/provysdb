...
class ProvysConnection implements DbConnection {
  ...
  public DbPreparedStatement prepareStatement(String sql) {
    try {
      return new ProvysPreparedStatement<>(sql, connection.prepareStatement(sql), sqlTypeMap);
    } catch (SQLException e) {
      throw new SqlException("Failed to parse statement:\n" + sql, e);
    }
  }
  ...
  public DbPreparedStatement prepareStatement(String sql, int resultSetType,
    ...
    try {
      return new ProvysPreparedStatement<>(sql,
          connection.prepareStatement(sql, resultSetType, resultSetConcurrency), sqlTypeMap);
    } catch (SQLException e) {
      throw new SqlException("Failed to parse statement:\n" + sql, e);
    }
  }
  ...
  public DbPreparedStatement prepareStatement(String sql, int resultSetType,
    ...
    try {
      return new ProvysPreparedStatement<>(sql, connection
  ...
  public DbPreparedStatement prepareStatement(String sql, int autoGeneratedKeys) {
    try {
      return new ProvysPreparedStatement<>(sql, connection.prepareStatement(sql, autoGeneratedKeys),
          sqlTypeMap);
    } catch (SQLException e) {
      throw new SqlException("Failed to parse statement:\n" + sql, e);
    }
  ...
  public DbPreparedStatement prepareStatement(String sql, int[] columnIndexes) {
    try {
      return new ProvysPreparedStatement<>(sql, connection.prepareStatement(sql, columnIndexes),
          sqlTypeMap);
    } catch (SQLException e) {
      throw new SqlException("Failed to parse statement:\n" + sql, e);
    }
  ...
  public DbPreparedStatement prepareStatement(String sql, String[] columnNames) {
    try {
      return new ProvysPreparedStatement<>(sql, connection.prepareStatement(sql, columnNames),
          sqlTypeMap);
    } catch (SQLException e) {
      throw new SqlException("Failed to parse statement:\n" + sql, e);
    }
  ...
  public DbCallableStatement prepareCall(String sql) {
    try {
      return new ProvysCallableStatement<>(sql, connection.prepareCall(sql), sqlTypeMap);
    } catch (SQLException e) {
      throw new SqlException("Failed to parse callable statement:\n" + sql, e);
    }
  }
  ...
  public DbCallableStatement prepareCall(String sql, int resultSetType, int resultSetConcurrency) {
    try {
      return new ProvysCallableStatement<>(sql,
