 ...
 */
interface DbSelectBuilderT<T extends DbSelectBuilderT<T>> {
  ...
  <T1> DbSelectBuilderBase<? extends SelectStatement, ? extends SelectT<?>, ?> column(
      SelectColumn<T1> column);
   ...
   */
  @SuppressWarnings("ClassReferencesSubclass")
  default <T1> DbSelectBuilderBase<? extends SelectStatement, ? extends SelectT<?>, ?> column(
      ExpressionBuilder<T1> column) {
