...
/**
 * Interface represents tokenizer, capable of parsing SQL source file into sequence of tokens. It can be either used to
 * retrieve stream of tokens itself or get list of binds aggregated from tokens
 */
public interface SqlTokenizer {
     ...
     * @return CodeBuilder containing normalized text of SQL statement and binds parsed from SQL statement
     */
