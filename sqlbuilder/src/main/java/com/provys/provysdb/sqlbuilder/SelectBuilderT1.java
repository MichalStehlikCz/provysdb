...
public interface SelectBuilderT1<T1> extends SelectBuilderBase<SelectBuilderT1<T1>, SelectBuilder> {
     ...
     */
    @Nonnull
    <T> SelectBuilderT2<T1, T> columnSql(String columnSql, String alias, Class<T> clazz, BindValue... binds);
     ...
     */
    @Nonnull
    <T> SelectBuilderT2<T1, T> columnSql(String columnSql, String alias, Iterable<BindValue> binds, Class<T> clazz);
}
