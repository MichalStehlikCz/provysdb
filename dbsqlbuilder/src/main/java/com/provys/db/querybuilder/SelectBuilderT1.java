 ...
 */
public interface SelectBuilderT1<T1> extends SelectBuilderBase<SelectBuilderT1<T1>, SelectBuilder> {
   ...
   * @return resulting select builder
   */
  <T> SelectBuilderT2<T1, T> column(SimpleName column, Class<T> clazz);
   ...
   * @return resulting select builder
   */
  <T> SelectBuilderT2<T1, T> column(SimpleName column, SimpleName alias, Class<T> clazz);
   ...
   * @return resulting select builder
   */
  <T> SelectBuilderT2<T1, T> column(QueryAlias tableAlias, SimpleName column,
   ...
   * @return resulting select builder
   */
  <T> SelectBuilderT2<T1, T> column(String tableAlias, String columnName, String alias,
      Class<T> clazz);
   ...
   * @return resulting select builder
   */
  <T> SelectBuilderT2<T1, T> column(SelectExpressionBuilder<T> expression, SimpleName alias);
