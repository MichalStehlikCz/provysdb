...
public interface DbSelectBuilderT2<T1, T2>
     ...
     */
    @Nonnull
    <T> DbSelectBuilder column(SqlTableAlias tableAlias, SqlIdentifier column, SqlIdentifier alias, Class<T> clazz);
     ...
     */
    @Nonnull
    <T> DbSelectBuilder columnDirect(String columnSql, String alias, Class<T> clazz, BindName... binds);
     ...
     */
    @Nonnull
    <T> DbSelectBuilder columnDirect(String columnSql, String alias, List<BindName> binds, Class<T> clazz);
     ...
     */
    @Nonnull
    <T> DbSelectBuilder columnSql(String columnSql, String alias, Class<T> clazz, BindValue... binds);
     ...
     */
    @Nonnull
    <T> DbSelectBuilder columnSql(String columnSql, String alias, Iterable<BindValue> binds, Class<T> clazz);
}
