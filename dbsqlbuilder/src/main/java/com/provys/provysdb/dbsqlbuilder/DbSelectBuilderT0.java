...
public interface DbSelectBuilderT0 extends DbSelectBuilderBase, SelectBuilderBase<DbSelectBuilderT0, DbSelectBuilder> {
     ...
     */
    @Nonnull
    <T> DbSelectBuilderT1<T> column(SqlTableAlias tableAlias, SqlIdentifier column, SqlIdentifier alias, Class<T> clazz);
     ...
     */
    @Nonnull
    <T> DbSelectBuilderT1<T> column(String tableAlias, String columnName, String alias, Class<T> clazz);
     ...
     */
    @Nonnull
    <T> DbSelectBuilderT1<T> columnDirect(String columnSql, String alias, Class<T> clazz, BindName... binds);
     ...
     */
    @Nonnull
    <T> DbSelectBuilderT1<T> columnDirect(String columnSql, String alias, List<BindName> binds, Class<T> clazz);
     ...
     */
    @Nonnull
    <T> DbSelectBuilderT1<T> columnSql(String columnSql, String alias, Class<T> clazz);
     ...
     */
    @Nonnull
    <T> DbSelectBuilderT1<T> columnSql(String columnSql, String alias, Class<T> clazz, BindValue... binds);
     ...
     */
    @Nonnull
    <T> DbSelectBuilderT1<T> columnSql(String columnSql, String alias, Iterable<BindValue> binds, Class<T> clazz);
}
