...
public interface SelectBuilderT2<T1, T2> extends
   ...
   * @return resulting select builder
   */
  <T> SelectBuilder column(SimpleName column, Class<T> clazz);
   ...
   * @return resulting select builder
   */
  <T> SelectBuilder column(SimpleName column, SimpleName alias, Class<T> clazz);
   ...
   * @return resulting select builder
   */
  <T> SelectBuilder column(QueryAlias tableAlias, SimpleName column, SimpleName alias,
      Class<T> clazz);
   ...
   * @return resulting select builder
   */
  <T> SelectBuilder column(SelectExpressionBuilder<T> expression, SimpleName alias);
   ...
   * @return resulting select builder
   */
  <T> SelectBuilder columnSql(String columnSql, String alias, Class<T> clazz, BindValueBuilder... binds);
   ...
   * @return resulting select builder
   */
  <T> SelectBuilder columnSql(String columnSql, String alias, Collection<? extends BindValueBuilder> binds,
      Class<T> clazz);
}