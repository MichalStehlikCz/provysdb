...
public interface SelectBuilderBase<T extends SelectBuilderBase<T, U>,
   ...
   * @return self to support fluent build
   */
  U column(SimpleName column, SimpleName alias);
   ...
   * @return self to support fluent build
   */
  U column(QueryAlias tableAlias, SimpleName column, SimpleName alias);
   ...
   * @return self to support fluent build
   */
  U column(SelectExpressionBuilder expression, SimpleName alias);
   ...
   * @return self to support fluent build
   */
  U columnSql(String columnSql, String alias, BindValueBuilder... binds);
   ...
   * @return self to support fluent build
   */
  U columnSql(String columnSql, String alias, Collection<? extends BindValueBuilder> binds);
   ...
   * @return self to support fluent build
   */
  T from(SimpleName tableName, QueryAlias alias);
   ...
   * @return self to support fluent build
   */
  T whereSql(String conditionSql, BindValueBuilder... binds);
   ...
   * @return self to support fluent build
   */
  T whereSql(String conditionSql, Collection<? extends BindValueBuilder> binds);
