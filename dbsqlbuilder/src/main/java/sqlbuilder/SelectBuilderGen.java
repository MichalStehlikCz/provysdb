...
public interface SelectBuilderGen<U extends SelectBuilderGen<U>> extends SelectBuilderBase<U, U> {
   ...
   * @return self to support fluent build
   */
  <T> U column(SimpleName column, Class<T> clazz);
   ...
   * @return self to support fluent build
   */
  <T> U column(SimpleName column, SimpleName alias, Class<T> clazz);
   ...
   * @return self to support fluent build
   */
  <T> U column(QueryAlias tableAlias, SimpleName column, SimpleName alias, Class<T> clazz);
   ...
   * @return self to support fluent build
   */
  <T> U column(SelectExpressionBuilder<T> expression, SimpleName alias);
   ...
   * @return self to support fluent build
   */
  <T> U columnSql(String columnSql, String alias, Class<T> clazz, BindValueBuilder... binds);
   ...
   * @return self to support fluent build
   */
  <T> U columnSql(String columnSql, String alias, Collection<? extends BindValueBuilder> binds,
      Class<T> clazz);
}
