...
/**
 * Select builder with no columns added so far.
 */
public interface SelectBuilderT0 extends SelectBuilderBase<SelectBuilderT0, SelectBuilder> {
   ...
   */
  <T> SelectBuilderT1<T> column(SqlColumn<T> column);
   ...
   * @return resulting select builder
   */
  <T> SelectBuilderT1<T> column(SimpleName column, Class<T> clazz);
   ...
   * @return resulting select builder
   */
  <T> SelectBuilderT1<T> column(SimpleName column, SimpleName alias, Class<T> clazz);
   ...
   * @return resulting select builder
   */
  <T> SelectBuilderT1<T> column(QueryAlias tableAlias, SimpleName column, SimpleName alias,
      Class<T> clazz);
   ...
   * @return resulting select builder
   */
  <T> SelectBuilderT1<T> column(SelectExpressionBuilder<T> expression, SimpleName alias);
   ...
   * @return resulting select builder
   */
  <T> SelectBuilderT1<T> columnDirect(String columnSql, String alias,
   ...
   * @return resulting select builder
   */
  <T> SelectBuilderT1<T> columnSql(String columnSql, String alias,
