...
public class DefaultResultSet implements DbResultSet {
   ...
   * @param sqlTypeHandler is type map used to translate column values in this database context
   */
  DefaultResultSet(ResultSet resultSet, SqlTypeHandler sqlTypeHandler) {
  ...
  public <T> @NonNull T getNonNullValue(String columnLabel, Class<T> type) {
    return sqlTypeHandler.readNonNullValue(this, columnLabel, type);
  }

  @Override
  public <T> @Nullable T getNullableValue(int columnIndex, Class<T> type) {
    return sqlTypeHandler.readNullableValue(this, columnIndex, type);
  }

  @Override
  public <T> @Nullable T getNullableValue(String columnLabel, Class<T> type) {
    return sqlTypeHandler.readNullableValue(this, columnLabel, type);
  }

  @Override
  public <T> Optional<@NonNull T> getOptionalValue(int columnIndex, Class<T> type) {
    return sqlTypeHandler.readOptionalValue(this, columnIndex, type);
  }

  @Override
  public <T> Optional<@NonNull T> getOptionalValue(String columnLabel, Class<T> type) {
    return sqlTypeHandler.readOptionalValue(this, columnLabel, type);
  }
