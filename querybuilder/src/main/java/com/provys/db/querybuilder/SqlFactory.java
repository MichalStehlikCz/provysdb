...
import com.provys.db.querybuilder.impl.NoDbSqlImpl;
...
public final class SqlFactory {
   ...
   */
  public static <T> BindValueBuilder<T> bind(BindName bindName, @NonNull T value) {
   ...
   * @return bind value with supplied name and value
   */
  public static <T> BindValueBuilder<T> bind(String name, @NonNull T value) {
   ...
   */
  public static <T> BindValueBuilder<T> bind(BindName bindName, @Nullable T value, Class<T> clazz) {
   ...
   * @return bind value of given type with supplied name and value
   */
  public static <T> BindValueBuilder<T> bind(String name, @Nullable T value, Class<T> clazz) {
   ...
   */
  public static <T> BindValueBuilder<T> bindEmpty(String name, Class<T> clazz) {
   ...
   */
  public static SimpleName name(String name) {
   ...
   */
  public static TableColumn column(SimpleName column) {
   ...
   * @return created column
   */
  public static TableColumn column(SimpleName column, SimpleName alias) {
   ...
   * @return created column
   */
  public static TableColumn column(QueryAlias tableAlias, SimpleName column) {
   ...
   * @return created column
   */
  public static <T> TableColumn<T> column(SimpleName column, Class<T> clazz) {
    return SQL.column(column, clazz);
  }
   ...
   * @return created column
   */
  public static <T> TableColumn<T> column(SimpleName column, SimpleName alias,
      Class<T> clazz) {
   ...
   * @return created column
   */
  public static <T> TableColumn<T> column(QueryAlias tableAlias, SimpleName column,
      Class<T> clazz) {
   ...
   * @return created column
   */
  public static SqlColumn columnSql(String sql, String alias, BindValueBuilder... binds) {
   ...
   * @return created column
   */
  public static <T> SqlColumn<T> columnSql(String sql, String alias, Collection<BindValueBuilder> binds,
      Class<T> clazz) {
   ...
   */
  public static FromClause from(SimpleName tableName, QueryAlias alias) {
   ...
   * @return created where condition
   */
  public static Condition conditionSql(String conditionSql, BindValueBuilder... binds) {
   ...
   * @return created where condition
   */
  public static Condition conditionSql(String conditionSql, Collection<BindValueBuilder> binds) {
    return SQL.conditionSql(conditionSql, binds);
  }
