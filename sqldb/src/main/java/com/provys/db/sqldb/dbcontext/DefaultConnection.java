...
public class DefaultConnection implements DbConnection {
   ...
   * @param sqlTypeMap is type map used for this connection
   */
  public DefaultConnection(Connection connection, SqlTypeMap sqlTypeMap) {
  ...
  public DbStatement createStatement() {
    try {
      return new DefaultStatement<>(connection.createStatement(), sqlTypeMap);
  ...
  public DbPreparedStatement prepareStatement(String sql) {
    try {
      return new DefaultPreparedStatement<>(sql, connection.prepareStatement(sql), sqlTypeMap);
    } catch (SQLException e) {
  ...
  public DbPreparedStatement prepareStatement(String sql, int autoGeneratedKeys) {
    try {
      return new DefaultPreparedStatement<>(sql,
          connection.prepareStatement(sql, autoGeneratedKeys), sqlTypeMap);
    } catch (SQLException e) {
      throw getParsePreparedException(sql, e);
    }
  }
  ...
  public DbCallableStatement prepareCall(String sql) {
    try {
      return new DefaultCallableStatement<>(sql, connection.prepareCall(sql), sqlTypeMap);
    } catch (SQLException e) {
