...
class DefaultStatement<T extends Statement> implements DbStatement {
  ...
  DefaultStatement(T statement, SqlTypeMap sqlTypeMap) {
  ...
  public DbResultSet executeQuery(String sql) throws SQLException {
    return new DefaultResultSet(statement.executeQuery(sql), getSqlTypeMap());
  }
  ...
  public DbResultSet getResultSet() throws SQLException {
    return new DefaultResultSet(statement.getResultSet(), getSqlTypeMap());
  }
  ...
  public DbResultSet getGeneratedKeys() throws SQLException {
    return new DefaultResultSet(statement.getGeneratedKeys(), getSqlTypeMap());
  }
