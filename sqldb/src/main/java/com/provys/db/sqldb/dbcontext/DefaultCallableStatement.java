...
public class DefaultCallableStatement<T extends CallableStatement> extends
   ...
   * @param sqlTypeMap        is type map used to translate binds in this database context
   */
  protected DefaultCallableStatement(String sql, T preparedStatement, SqlTypeMap sqlTypeMap) {
